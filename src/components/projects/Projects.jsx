...
/**
 * Projects data
 * - Each project includes a title, description, and image path
 */
const projects = [
  ...
  { title: "Edusity University Frontend", desc: "React • TailwindCSS • Fully Responsive University Website", image: "/images/work-5.jpg"  },
 ...
 * - Displays a grid of projects the user has built
 * - Hovering reveals project title and tech stack description
 */
const Projects = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-sm sm:text-base">
            A showcase of apps and interfaces I’ve developed — from cloud-hosted platforms to real-time Firebase apps. 
            View source code on <a href="https://github.com/Mash24?tab=repositories" className="text-lime-600 hover:underline">GitHub</a>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {projects.map((project, index) => (
            ...
            >
              ...
              {/* Hover Overlay: Project Title and Description */}
