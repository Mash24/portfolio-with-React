      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm sm:text-base">
            <span className="text-green-600">Got a project?</span> DevOps challenge, or just want to network? I'm open to freelance gigs, mentorship, or full-time roles in Cloud and Engineering.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+66952819402" className="text-lime-700 text-sm hover:underline">+66 95-281-9402</a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:jackmwakano@gmail.com" className="text-lime-700 text-sm hover:underline">jackmwakano@gmail.com</a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://iamjackson.netlify.app" target="_blank" rel="noopener noreferrer" className="text-lime-700 text-sm hover:underline">
